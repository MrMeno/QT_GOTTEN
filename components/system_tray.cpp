...
system_tray::system_tray(QWidget *parent):QSystemTrayIcon(parent)
{
createBottomWidget();
createTopWidget();
}
...
void system_tray::createTopWidget()
{
...
void system_tray::createBottomWidget()
{
    m_bottomWidget = new QWidget();
    m_bottomWidgetAction = new QWidgetAction(m_trayMenu);

    m_updateBtn = new QPushButton(QIcon(":/img/icon_close.png"), QStringLiteral("Update"));
    m_updateBtn->setObjectName(QStringLiteral("TrayButton"));
    m_updateBtn->setFixedSize(60, 25);

    m_aboutBtn = new QPushButton(QIcon(":/img/icon_close.png"), QStringLiteral("About"));
    m_aboutBtn->setObjectName(QStringLiteral("TrayButton"));
    m_aboutBtn->setFixedSize(60, 25);

    m_exitBtn = new QPushButton(QIcon(":/img/icon_close.png"), QStringLiteral("Exit"));
